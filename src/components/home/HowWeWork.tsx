...
export function HowWeWork() {
  ...
  return (
    <>
      ...
      <MaxWidthContainer bgColor={theme.palette.primary.main}>
          ...
          >
            <Box display="flex" flexDirection="column" gap={pxToRem(30)}>
              <Typography
                sx={{
                  fontSize: {
                    xs: pxToRem(hFontSize.base),
                    sm: pxToRem(hFontSize.sm),
                  },
                }}
                variant="h2"
              >
              ...
              <WorkText>
                ...
                reaching for the most aggressive goal they can reach. When
                budgets are small, impact needs to be high. Creativity and
                strategic thinking must work hand in hand to hand to
                breakthrough vs accept a status quo.
              </WorkText>
              <WorkText>
                ...
                proof and case studies from companies like Honey, Sofi,
                Pinterest to prove it.
              </WorkText>
              <WorkText>
                JBrad Advisors will help leaders and teams get excited about
                what they can do quickly to drive momentum, keep partnerships
                and agencies engaged and perform better.
              </WorkText>
            </Box>
            {atLeastMd && (
              <Box
